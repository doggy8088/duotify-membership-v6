...
**Tests**: The examples below include test tasks. Tests are REQUIRED when code,
integration behavior, or regressions are affected. The generated task list MUST
include the automated coverage needed by the constitution.
...
- [ ] T004 [P] Configure automated test and quality gates
...
- [ ] T011 [P] [US1] Unit test for [core behavior] in tests/unit/test_[name].py
...
- [ ] T019 [US1] Verify loading, empty, success, and error states for User Story 1
- [ ] T020 [US1] Capture performance evidence for User Story 1 against the plan budget
...
- [ ] T021 [P] [US2] Unit test for [core behavior] in tests/unit/test_[name].py
...
- [ ] T028 [US2] Verify UX consistency for User Story 2
- [ ] T029 [US2] Capture performance evidence for User Story 2 against the plan budget
...
- [ ] T030 [P] [US3] Unit test for [core behavior] in tests/unit/test_[name].py
...
- [ ] T036 [US3] Verify UX consistency for User Story 3
- [ ] T037 [US3] Capture performance evidence for User Story 3 against the plan budget
...
- [ ] TXXX [P] Additional automated regression coverage in tests/unit/
...
- UX state validation and performance evidence before story completion
